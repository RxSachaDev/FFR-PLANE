...
public class FonctionsDialog extends javax.swing.JDialog{
    ...
    /**
     * Creates new form FonctionsDialog
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FonctionsDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FonctionsDialog dialog = new FonctionsDialog(new javax.swing.JFrame(), true);

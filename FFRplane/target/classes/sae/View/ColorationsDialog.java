...
/**
 * Cette classe correspond à la dialog comportant tout les éléments liés aux couleurs et permet l'édition et la
 * modification de tout ces éléments
 * @author fillo
 */
public class ColorationsDialog extends javax.swing.JDialog {
    private static final IconUtil iconU = new IconUtil();
    /**
     * Creates new form ColorationsDialog
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColorationsDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ColorationsDialog dialog = new ColorationsDialog(new javax.swing.JFrame(), true);

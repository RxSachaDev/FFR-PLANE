 ...
 * @author fillo
 */
public class AirportpointRender extends WaypointPainter<AirportWaypoint> {
    ...
    protected void doPaint(Graphics2D g, JXMapViewer map, int width, int height){
        for(AirportWaypoint ap : getWaypoints()){  // Parcours tous les points d'aéroport à peindre
